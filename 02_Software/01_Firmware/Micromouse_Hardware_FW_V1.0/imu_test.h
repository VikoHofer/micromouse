...
#define BNO055_ACCEL_DATA_X_LSB_ADDR      0x28	//without gravity, 0x08 is with gravity
...
//Acceleration wird zum Einstellen der Regler ben�tigt
void Acceleration(BNO055_Handle_t *bno);
//IMUDirection soll angeben, ob eine 90 Grad Drehung durchgef�hrt wurde
