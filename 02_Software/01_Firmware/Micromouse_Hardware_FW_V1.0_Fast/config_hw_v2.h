...
File		: config_hw_v2.h
Description	: Hardware specific configuration V2
Date		: 15.04.2026
*************************************************************/

#ifndef CONFIG_HW_V2_H
#define CONFIG_HW_V2_H
...
#define MOTOR_HW_V2 2

#define TARGET_MOTOR MOTOR_HW_V2
...
// Encoder Layout (LEFT <--> RIGHT)
#define ENCODER_HW_V2 2

#define TARGET_ENCODER ENCODER_HW_V2
...
#define DISTANCE_FIELD 180
#define ROTATION_DEG 90.5

#define DRIVE_TRIM_LEFT   1.00f
#define DRIVE_TRIM_RIGHT  1.00f
 ...
 * Hardware selection
 * ---------------------------------------------------------- */
#define SENSOR_HW_TOF       2

#ifndef TARGET_SENSOR_HW
#define TARGET_SENSOR_HW SENSOR_HW_TOF
#endif
