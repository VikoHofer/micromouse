...
bool Motion_CommandCurveAngleAdaption(float arc_angle_deg, float radius_mm, float top_speed_mms, float accel_mms2, float final_speed_mms, float* currentAngle);
