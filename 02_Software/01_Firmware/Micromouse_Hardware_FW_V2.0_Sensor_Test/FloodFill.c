	...
	for(int i = 0; i < fastPathIndex;i++){
		if(pathCommands[i].isMove == true){
			...
			if(pathCommands[i].distance < 100.0f){
				Motion_CommandCurveAngle(pathCommands[i].distance, 90.0f, 500.0f, 99999.0f, final_Speed);
			}
			else{
				Motion_CommandCurveAngle(pathCommands[i].distance, 90.0f, 300.0f, 99999.0f, final_Speed);
			}
		}
