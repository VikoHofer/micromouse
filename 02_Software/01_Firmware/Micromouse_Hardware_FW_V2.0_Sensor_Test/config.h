...
#define WALL_45_BACKEND_ADC_IR    2

#define IR_DELAY                  1

#define WALL_45_BACKEND           WALL_45_BACKEND_ADC_IR
...
#define IR_WALL_VALID_MAX        150.0f

#define IR_WALL_LEFT_REF         100.0f
#define IR_WALL_RIGHT_REF        100.0f

#define IR_WALL_DEADBAND         2.0f
#define IR_WALL_FILTER_ALPHA     0.0f

#define IR_WALL_KP               5.0f
#define IR_WALL_KD               1.0f

#define IR_WALL_MAX_ADJUST_DPS   90.0f
