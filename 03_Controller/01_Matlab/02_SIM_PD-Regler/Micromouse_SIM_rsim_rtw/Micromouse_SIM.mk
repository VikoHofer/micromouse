...
MODEL                   = Micromouse_SIM
MODULES                 = rt_logging.c Micromouse_SIM.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c rt_sim.c ode3.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\Micromouse_SIM.exe
MAKEFILE                = Micromouse_SIM.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2023b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2023b
START_DIR               = C:\Users\elias\Desktop\FH_Hagenberg\4.Semester\01_PRO4\04_Reglerdesign\01_Matlab
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 8
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="C:\\Program Files\\MATLAB\\R2023b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DRT -DRSIM_PARAMETER_LOADING -DTID01EQ=1"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = /LIBPATH:"C:\Program Files\MATLAB\R2023b\extern\lib\win64\microsoft" libmat.lib libmx.lib libut.lib libmwsl_fileio.lib libmwsl_simtarget_instrumentation.lib libmwi18n.lib libmwsigstream.lib libmwsl_AsyncioQueue.lib sf_runtime.lib
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Micromouse_SIM_ref.rsp
COMPILER_COMMAND_FILE     = Micromouse_SIM_comp.rsp
...
rsim_sup.obj : $(MATLAB_ROOT)\rtw\c\rsim\rsim_sup.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\rtw\c\rsim\rsim_sup.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\rtw\c\rsim\rsim_sup.c

rsim_mat.obj : $(MATLAB_ROOT)\rtw\c\rsim\rsim_mat.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\rtw\c\rsim\rsim_mat.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\rtw\c\rsim\rsim_mat.c
...
rsim_utils.obj : $(MATLAB_ROOT)\rtw\c\src\rapid\rsim_utils.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\rtw\c\src\rapid\rsim_utils.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\rtw\c\src\rapid\rsim_utils.c
...
rt_sim.obj : $(MATLAB_ROOT)\rtw\c\src\rt_sim.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\rtw\c\src\rt_sim.c
